...
func NewHighLevelLinstorClientFromConfig(endpoint string, config *piraeusv1.LinstorClientConfig, secretFetcher SecretFetcher) (*HighLevelClient, error) {
...
func newTLSConfigFromConfig(cfg *piraeusv1.LinstorClientConfig, secretFetcher SecretFetcher) (*tls.Config, error) {
...
func NewClientConfigForAPIResource(endpoint string, resource *piraeusv1.LinstorClientConfig) *LinstorClientConfig {
	clientCAPath := ""
	clientCertPath := ""
	clientKeyPath := ""
...
func APIResourceAsEnvVars(endpoint string, resource *piraeusv1.LinstorClientConfig) []corev1.EnvVar {
	env := []corev1.EnvVar{
		{
			Name:  "LS_CONTROLLERS",
			Value: endpoint,
